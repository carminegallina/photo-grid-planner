...
import com.niwlayr.app.MainActivity
...
class PublicationReminderReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ActionReminder = "com.niwlayr.app.ACTION_PUBLICATION_REMINDER"
        const val ActionCopyPublicationText = "com.niwlayr.app.ACTION_COPY_PUBLICATION_TEXT"
