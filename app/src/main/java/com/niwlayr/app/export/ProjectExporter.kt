package com.niwlayr.app.export
...
object ProjectExporter {
    ...
    fun defaultZipName(prefix: String = "NiwLayrCreatorStudio"): String {
    ...
    fun exportToZip(
        ...
        return exportPostsToZip(
            ...
            zipUri = zipUri,
            posts = state.posts,
            exportTitle = "NiwLayr - Creator Studio",
            orderText = orderText,
        )
    }
    ...
    fun exportToFolder(
        ...
        return exportPostsToFolder(
            ...
            posts = state.posts,
            exportTitle = "NiwLayr - Creator Studio",
            folderPrefix = "NiwLayrCreatorStudio",
            orderText = orderText,
        )
    }
    ...
    fun exportPostsToFolder(
        ...
        posts: List<GridPost>,
        exportTitle: String,
        folderPrefix: String = "NiwLayrCreatorStudio",
        orderText: String? = null,
    ): Int {
