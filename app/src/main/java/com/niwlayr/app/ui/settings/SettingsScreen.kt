package com.niwlayr.app.ui.settings
    ...
    Column(
        ...
        SettingsPanel(title = "Backup progetto") {
            ...
            FlowRow(
                ...
                OutlinedButton(onClick = { backupExporter.launch("NiwLayrCreatorStudio_backup.json") }) {
        ...
        SettingsPanel(title = "Copyright") {
            LocalizedText(
                text = "NiwLayr - Creator Studio (c) 2026 Carmine Gallina. Tutti i diritti riservati.",
                style = MaterialTheme.typography.bodyMedium,
