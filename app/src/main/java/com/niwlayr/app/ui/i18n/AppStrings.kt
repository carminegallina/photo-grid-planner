package com.niwlayr.app.ui.i18n
...
private val EnglishStrings = mapOf(
    ...
    "NiwLayr - Creator Studio (c) 2026 Carmine Gallina. Tutti i diritti riservati." to
        "NiwLayr - Creator Studio (c) 2026 Carmine Gallina. All rights reserved.",
    ...
    "NiwLayr - Creator Studio" to "NiwLayr - Creator Studio",
    ...
    "Tutte" to "All",
    "Disponibili" to "Available",
    "Nella griglia" to "In grid",
    "Pianificate" to "Scheduled",
    "Pianificata" to "Scheduled",
    "Creazioni app" to "App creations",
    "Creata con l'app" to "Created with the app",
    "Selezionata" to "Selected",
    "Carico libreria..." to "Loading library...",
    "Nessuna foto corrisponde a questo filtro" to "No photos match this filter",
    "Mostra tutte" to "Show all",
    "Impossibile leggere la libreria foto" to "Unable to read the photo library",
    "Controlla l'accesso alle foto e riprova." to "Check photo access and try again.",
    "Riprova" to "Try again",
    "Album" to "Albums",
